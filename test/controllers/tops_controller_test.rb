...
class TopsControllerTest < ActionController::TestCase
  ...
  test "should create top" do
    assert_difference('Top.count') do
      post :create, top: { category: @top.category, tags: @top.tags, title: @top.title, user_id: @top.user_id }
    end
  ...
  test "should update top" do
    patch :update, id: @top, top: { category: @top.category, tags: @top.tags, title: @top.title, user_id: @top.user_id }
    assert_redirected_to top_path(assigns(:top))
  end
